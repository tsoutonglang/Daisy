module.exports = {
    ...
    execute(guildMember, Discord, embedColor){
        ...
        if (guildMember.guild.id === baebee) {
            const BaeBeechannel = guildMember.guild.channels.cache.get('738306568675786803');
            ...
            BaeBeechannel.send(`<a:bee:858626567608729651> <@${guildMember.user.id}> <a:bee:858626567608729651>\n`, {embed: welcomeMsg});
        } else {
            return;
        }        
    }
