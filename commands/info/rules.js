    ...
    execute(message) {
        ...
        if (message.member.roles.cache.has('738248181959229513')){
            ...
            let ruleS2 = `** **\n`
                ...
                + `<a:sideheart:858626585184043018> **7・Don't try to bypass banned words**\nSaying these words by altering a letter and/or adding symbols will result in a warning or ban, and you will be muted. These words include (tw: potentially triggering words) ||r\\*pe/r\\*pist/r\\*ping|| ||f\\*g/f\\*ggot|| ||ch\\*nk|| ||n\\*gga/n\\*gger|| ||p\\*rn/p\\*rnography|| ||r\\*tard/r\\*tarded|| ||d\\*ke|| ||tr\\*nny||.\n\n`
