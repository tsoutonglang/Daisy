    ...
    execute(message) {
        ...
        if (message.member.roles.cache.has('738248181959229513')){
            ...
            let ruleS1 = `<a:sideheart:858626585184043018> **1・Must abide by Discord's Terms of Service and guidelines**\nhttps://discord.com/terms\nhttps://discord.com/guidelines\n\n`
                ...
                + `<a:sideheart:858626585184043018> **4・Images and/or links of NSFW, extreme gore (real death and severed body parts), or glorification/promotion of suicide, self harm, and/or health disorders will result in an __automatic ban__**\n Sexualizing any server members, our members' original characters, and any characters who are canonically underage (ie. in middle/high school and there is no *canon* timeskip) in any way is a **bannable** offense.\n__If you do need to vent about suicide/self harm/health disorders, please go to <#738268047600648283> or <#766124910744829952> or contact your local suicide hotline.__\n\n`
            ...
            let ruleS2 = `** **\n`
                ...
                + `<a:sideheart:858626585184043018> **7・Don't try to bypass banned words**\nSaying these words by altering a letter and/or adding symbols will result in a warning or ban, and you will be muted. These words include (open with caution b/c they're potentially triggering) ||r\*pe/r\*pist/r\*ping|| ||f\*g/f\*ggot|| ||ch\*nk|| ||n\*gga/n\*gger|| ||p\*rn/p\*rnography|| ||r\*tard/r\*tarded|| ||d\*ke|| ||tr\*nny||.\n\n`
