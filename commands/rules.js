module.exports = {
    ...
    execute(message, args) {
        ...
        let ruleS2 = `** **\n`
            ...
            + `<a:sideheart:858626585184043018> **7・Don't try to bypass banned words**\nThese words are *banned* from the server. Saying these words by altering a letter and/or adding symbols will result in a warning or ban. These words include ||rape/rapist/raping|| ||fag/faggot|| ||chink|| ||nigga/nigger|| ||porn|| ||cum|| ||retard/retarded||\n\n`
